        ...
        {data?.lpp_document?.type_collaboration === "RevenueSharing" ? ( 
         ...
         <View>
          ...
          <View style={styles.row}>
           ...
           <Text style={styles.colon}>:</Text>
           <Text style={styles.value}>{data.lpp_document && data?.lpp_document.shipping_cost ?  data?.lpp_document?.shipping_cost.charAt(0).toUpperCase() + data?.lpp_document?.shipping_cost.slice(1) : ""}</Text>
          </View>
          <View style={styles.row}>
